...
function getConfettiShapeOptions(teamCode?: string) {
    if (!teamCode) {
        return {
...
function getPosition(matchCard: HTMLElement, winnerSide: "home" | "away") {
...
function fireConfetti(matchCard: HTMLElement, index: number) {
